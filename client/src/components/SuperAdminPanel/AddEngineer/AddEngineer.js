...
//         method: 'PUT', // Change to PUT to match your backend API
//         headers: {
//           'Content-Type': 'application/json',
//         },
//         body: JSON.stringify(rows.map(row => row.email)), // Send array of emails
//       });
...
//     try {
//       const response = await fetch('http://localhost:1760/update-role', { // Adjust the URL if necessary
//         method: 'PUT',
//         headers: {
//           'Content-Type': 'application/json',
//         },
//         body: JSON.stringify({ emails: rows.map(row => row.email) }), // Send an object with emails
//       });

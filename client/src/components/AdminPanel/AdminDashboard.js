...
// function Sidebar({ isOpen, handleLogout, closeSidebar }) {
//   return (
...
//         // Play animation class before logout
//         document.body.classList.add("fade-out"); // Add a class for fade-out animation
//         setTimeout(() => {
